...
public class AdminQuestionListController {
    ...
    private void handleAdd(ActionEvent event) {
        ...
        try {
            FXMLLoader loader = ControllerUtils.createLoader("/question_add.fxml");
    ...
    private void editQuestion(Question question, ActionEvent event) {
        try {
            FXMLLoader loader = ControllerUtils.createLoader("/question_edit.fxml");
            Parent root = loader.load();
    ...
    private void handleBack(ActionEvent event) {
        try {
            Parent root = ControllerUtils.loadFxml("/admin_quiz_list.fxml");
            switchScene(event, root);
